<template lang="pug">
  .grid
    ...
    .notification
      img(src="https://cdn-images-1.medium.com/max/1600/1*rrRcaZKZsjerUveQqTSx7A.png")
      p One of my favorite places to study is in Platzi.
      p It is an online education platform with more than 1,000,000 students around the world.
      br
